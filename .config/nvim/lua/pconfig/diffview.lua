...
return {
	...
	cmd = { "DiffviewFileHistory", "DiffviewOpen", "DiffviewOpenJj", "JjDiffviewOpen" },
	...
	config = function()
		vim.keymap.set("n", "<leader>gd", function()
			require("jjsigns").change_base("heads(::@ & ::main)", true)
			require("pconfig.jj_diffview").open({ from = "heads(::@ & ::main)" })
